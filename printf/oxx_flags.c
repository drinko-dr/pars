...
/*   Updated: 2019/10/21 22:57:25 by drinko           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			oxx_flags(va_list *ap, t_flag **flag, char **str)
{
	...
	**str == (*((*flag)->flag = "X\0\0"))) && (++n))
	...
	(n += 2))
		len = flag_d((unsigned long)va_arg(*ap, unsigned long int),
		flag, &print_base, 16);
